/*** Generated by streamline 0.4.5 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb; (function() {
  ...
  Neo4j = (function() {
    ...
    Neo4j.prototype.all = function Neo4j_prototype_all__8(model, filter, _) { var dir, indeces, indexProperty, indexValue, key, keys, nodes, props, value, whereArgs, whereQuery, _this, __this = this; var __frame = { name: "Neo4j_prototype_all__8", line: 259 }; return __func(_, this, arguments, Neo4j_prototype_all__8, 2, __frame, function __$Neo4j_prototype_all__8() { _this = __this;
        ...
        return (function __1(_) { var _ref, _results; _ref = filter.where; _results = []; for (key in _ref) { value = _ref[key]; _results.push(((("" + key) + ":") + value)); }; return _(null, _results); })(__cb(_, __frame, 20, 18, function ___(__0, __4) { whereArgs = __4;
          whereQuery = (whereQuery + whereArgs.join(" AND ")); return (function __$Neo4j_prototype_all__8(__then) {
            if (indexProperty) {
              return __this.client.queryIndexedNodes(model, indexProperty, indexValue, whereQuery, __cb(_, __frame, 23, 16, function ___(__0, __5) { return __5.map_(__cb(_, __frame, 23, 16, function ___(__0, __6) { nodes = __6; __then(); }, true), function __2(_, obj) { var __frame = { name: "__2", line: 282 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() {
                    obj.data.id = obj.id;
                    return _(null, _this.readFromDb(model, obj.data)); }); }); }, true)); } else {


              return __this.client.queryNodeIndex(model, whereQuery, __cb(_, __frame, 28, 16, function ___(__0, __7) { return __7.map_(__cb(_, __frame, 28, 16, function ___(__0, __8) { nodes = __8; __then(); }, true), function __3(_, obj) { var __frame = { name: "__3", line: 287 }; return __func(_, this, arguments, __3, 0, __frame, function __$__3() {
                    obj.data.id = obj.id;
    ...
    Neo4j.prototype.allNodes = function Neo4j_prototype_allNodes__9(model, _) { var __this = this; var __frame = { name: "Neo4j_prototype_allNodes__9", line: 305 }; return __func(_, this, arguments, Neo4j_prototype_allNodes__9, 1, __frame, function __$Neo4j_prototype_allNodes__9() {
        return __this.client.queryNodeIndex(model, "id:*", __cb(_, __frame, 1, 13, _, true)); }); };


    Neo4j.prototype.destroyAll = function Neo4j_prototype_destroyAll__10(model, _) { var __this = this; var __frame = { name: "Neo4j_prototype_destroyAll__10", line: 309 }; return __func(_, this, arguments, Neo4j_prototype_destroyAll__10, 1, __frame, function __$Neo4j_prototype_destroyAll__10() {
        return __this.allNodes(model, __cb(_, __frame, 1, 13, function ___(__0, __3) { return __3.forEach_(__cb(_, __frame, 1, 13, _, true), function __1(_, node) { var __frame = { name: "__1", line: 310 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
              return node["delete"](__cb(_, __frame, 1, 15, _, true), true); }); }); }, true)); }); };



    Neo4j.prototype.count = function Neo4j_prototype_count__11(model, _, conds) { var collection, __this = this; var __frame = { name: "Neo4j_prototype_count__11", line: 315 }; return __func(_, this, arguments, Neo4j_prototype_count__11, 1, __frame, function __$Neo4j_prototype_count__11() {
    ...
    Neo4j.prototype.updateAttributes = function Neo4j_prototype_updateAttributes__12(model, id, data, _) { var node, __this = this; var __frame = { name: "Neo4j_prototype_updateAttributes__12", line: 326 }; return __func(_, this, arguments, Neo4j_prototype_updateAttributes__12, 3, __frame, function __$Neo4j_prototype_updateAttributes__12() {
